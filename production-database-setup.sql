-- Production Database Setup for SceneWork
...
-- 2. Create profiles table first (base table)
...
-- 7. Create messages table with proper foreign keys
...
-- 11. Create RLS policies for follows
...
-- 13. Create RLS policies for marketplace_listings
...
-- 15. Grant permissions on all tables
...
-- 17. Create function to automatically create profiles for new users
...
-- Success message
SELECT 'Production database setup complete! SceneWork is ready for deployment.' as status;
